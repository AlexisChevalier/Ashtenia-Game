...
namespace _2NET_Project.Managers
{
    class MonsterManager
    {
        ...
        public MonsterManager(Player player, Cell cell)
        {
            ...
            attackRate = rand.Next((attackRate + (levelBlocked - 1) * 6), (attackRate + levelBlocked * 6));

            missRate = rand.Next((missRate - levelBlocked * 3), (missRate - (levelBlocked - 1) * 3));

            health = rand.Next((health + (level - 1)*60), (health + level*60));
